...
if __name__ == "__main__":
    ...
    group = "bottom_1000"  # top_1000
    while True:
        url = (
            f"https://www.imdb.com/search/title/?groups={group}&languages=en&count=100&start="
            + str(page)
            + "&ref_=adv_nxt"
        )
        ...
        for movie_content in list_item_content:
            ...
            mc_link_elem = mc_soup.select_one(
    ...
    movie_df.to_csv(f"imdb_{group}.csv", index=False)
